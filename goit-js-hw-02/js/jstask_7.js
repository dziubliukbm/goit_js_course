...
const isLoginValid = function (login) {
  login.length > 3 && login.length < 16 ? true : console.log(`Ошибка! Логин ${login} должен быть от 4 до 16 символов`);
};

const isLoginUnique = function (logins, login) {
  logins.includes(login) ? console.log(`Такой логин - ${login} уже используется!`) : true;
};
